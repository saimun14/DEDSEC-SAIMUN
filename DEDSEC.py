...
\033[1;94m       [+]===============================================[+]
\033[1;94m       [+]        CREATED BY   :  Saimun Hridoy Hridoy          \033[1;94m[+]
\033[1;94m       [+]        ON GITHUB    :   Saimun14                               \033[1;94m[+]
\033[1;94m       [+]        TEAM         :  Team DEDSEC                              \033[1;94m[+]
...
class Main:
    def __init__(self):
        ...
        if Saimun in ["1", "01"]:
            num()
        if Saimun in ["2","02"]:
            os.system('xdg-open https://www.facebook.com/saimun.salamhridoy.1')
        if Saimun in [" 0", "00"]:
            exit()
        else:
            exit()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mSaimun\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
